...
\begin{thm}[Lefschetz fixed point theorem]\index{Lefschetz fixed point theorem}\index{fixed point theorem!Lefschetz}
  Let $M$ be a compact $d$-dimensional $\Z$-oriented manifold, and let $f: M \to M$ be a map such that the graph $\Gamma_f$ and diagonal $\Delta$ intersect transversely.
  Then we have
  \[
